...
6. Выполняется генерация результата: всегда создаются и текстовый список, и Excel‑файл. Затем выполняется проверка условий: если общее число уникальных сущностей (участники + упоминания) меньше или равно 50, пользователю отправляется текстовый список как обычное сообщение; если больше или равно 51 — отправляется Excel‑файл как документ. Все данные обрабатываются в памяти и не сохраняются на диск.
